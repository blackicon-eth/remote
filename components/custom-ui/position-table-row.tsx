      ...
      >
        ...
        <div className="flex justify-start items-center shrink-0 w-[50%]">
          <div className="flex justify-center items-center w-[96px]">
            {position.images.slice(1).map((image, index) => (
              <img
                key={index}
                src={image}
                alt={position.name}
                ...
                style={{
                  marginLeft:
                    index === 0 ? 0 : position.images.length > 4 ? -20 : -14,
                  width: position.images.length === 2 ? "40px" : "35px",
                  height: position.images.length === 2 ? "40px" : "35px",
                }}
              />
            ))}
          </div>
